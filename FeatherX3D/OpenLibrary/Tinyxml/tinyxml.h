...
public:
	...
	*/
	...
	void SetINT64Attribute( const char * name, __int64 val );
	void SetUINT64Attribute( const char * name, unsigned __int64 val );
...
public:
	...
	*/
	...
	bool LoadBuffer( char* xmlBuf, const int nBufLen, TiXmlEncoding encoding = TIXML_DEFAULT_ENCODING );
